$(function(){
	//选择时间
	(function(){
		var $mainBtn = $('header .free');
		var $mainTitle = $('header .mainTitle');
		var $filterDialog = $('#filterDialog');
		var $mainCancel = $filterDialog.find('.cancel');
		var $mainSure = $filterDialog.find('.sure');
		var $lis = $filterDialog.find('li');
		//
		var date = new Date();
		...
		var $btn = $('#filterDialog .start');
		var $btn2 = $('#filterDialog .finish');
